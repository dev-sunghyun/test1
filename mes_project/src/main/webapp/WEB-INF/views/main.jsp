...
<link rel="stylesheet" type="text/css" href="/mes_project/css/main.css">
<link rel="stylesheet" type="text/css" href="/mes_project/css/chatAIPopup.css">
<style>
@font-face {
...
<!-- 							<li><a href="facilityMonitoring.html">설비 모니터링</a></li> -->
					...
					<div class="menu-bar-content">
						<ul>
							<li><a href="boardTable.do">자유게시판</a></li>
