...
<%-- 		                                    	<% if ("ADMIN".equals(role)) { %> --%>
	                                    		<div class="delete-safety-checkbox">
	                                            	<input type="checkbox" class="delete-safety-check" name="w_bord_seq" value="${ i.w_bord_seq }">
		                                        	</div>
<%--  		                                        <% } %> --%>
	                                    		<div class="work-safety-order">
	                                    			<p class="w_title">
	                                    		...
	                                    		<div class="work-safety-img">
	                                    			<img src="http://localhost:8080/mes/fileDownload?fileName=${i.w_imgUrl}">
	                                    		</div>
	                                    	</div>            
	                                    </c:forEach>
                                    </c:if>
...
<!--                         </div> -->
					...
					<form method="post" action="workSafety" enctype="multipart/form-data">
	                        ...
	                        <div class="safety-add-popup-content">
	                            ...
	                            <div class="img-note">
	                                ...
	                                <div class="img-preview-box">
	                                    <div class="addImgBox">
	                                        <input type="text" id="add-img" name="w_img">
	                                        <input type="file" id="add-img-button" class="img-button" type="file"
	                                            style="display: none;" name="w_imgFile">
					...
					<form method="post" action="workSafety/update" enctype="multipart/form-data">
	                       <div id="order-retouch-popup" class="retouch-popup">
	                           <div class="retouch-popup-content">
	                               ...
	                               <div class="img-note">
	                                   ...
	                                   <div class="img-preview-box">
	                                       <div class="addImgBox">
	                                           <input type="text" id="retouch-img" name="w_img">
	                                           <input type="file" id="retouch-add-img-button" class="img-button" type="file"
	                                               style="display: none;" name="w_imgFile">
