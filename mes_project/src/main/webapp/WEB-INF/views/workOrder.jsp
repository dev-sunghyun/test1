...
<%-- 		                                    	<% if ("ADMIN".equals(role)) { %> --%>
		                                    		<div class="delete-checkbox">
		                                            	<input type="checkbox" class="delete-check" name="w_bord_seq" value="${ i.w_bord_seq }">
 		                                        	</div>
<%--  		                                        <% } %> --%>
		                                    		<div class="workOrder">
		                                    			<p class="w_title">
...
// 					            }
                        ...
                        <form method="post" action="workOrder/update" enctype="multipart/form-data">
	                                   ...
	                                   <div class="img-preview-box">
	                                       <div class="addImgBox">
	                                           ...
	                                           <input type="file" id="retouch-add-img-button" class="img-button" type="file"
	                                               style="display: none;" name="w_imgFile">
	                                           <label for="retouch-add-img-button" id="retouch-file-button">파일선택</label>
