...
<body>
	...
	<nav>
		<form name="frm" action="login" method="post"
			...
			<div class="loginBox">
				<div class="input">
					<input type="text" name="userid" class="input1" autofocus placeholder="아이디" value="taewon10">
					<br> 
					<input type="password" name="password" class="input2" placeholder="비밀번호" value="pass123">
				</div>
