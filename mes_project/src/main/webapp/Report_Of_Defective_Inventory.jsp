				...
				<article>
					...
					<div class="add_img">
						...
						<div class="searchbox">
							...
							<div>
								<img class="glasses"
									src="https://media.discordapp.net/attachments/1186454147558551552/1201320591920218232/2866321.png?ex=65c963fc&is=65b6eefc&hm=f58ed04bf70d9aa052a073134c27106ecce4726dd07fb3124e0ba9b81fddcadd&=&format=webp&quality=lossless&width=468&height=468"></img>
							</div>
						</div>
	...
	<script>
        ...
        document.addEventListener('click', function (event) {
            if (event.target.classList.contains('add_Stock')) {
                ...
                imageBox.src = "https://media.discordapp.net/attachments/1186454147558551552/1203715419811217428/KakaoTalk_20240130_103821101_01.png?ex=65f70458&is=65e48f58&hm=cae12a12da6b81468eb8621002f0be063e02644a087b0c246d8df4dbfaace3e1&=&format=webp&quality=lossless&width=666&height=666";
            }
        });
