								...
								<div class="table_SPH">
									...
									<div class="row_SPH">
										...
										<div class="cell_SPH_D1">
											<input type="text" value="<%=dto2.getMesGrade()%>" READONLY>
										</div>
										<div class="cell_SPH_D2">
											<input type="text" value="<%=dto2.getOrderQuantity()%>"
												READONLY>
										</div>
					...
					<div class="itemList">
						<div class="item">
							...
							<div class="itemInfor2">
								...
								<div class="itemIndex2"><%=srDTO.getMesContent()%></div>
								<div class="itemMesPrice" style="display: none">
									<%=srDTO.getMesPrice()%></div>
								<div class="itemIndex1"><%=srDTO.getGCount()%></div>
